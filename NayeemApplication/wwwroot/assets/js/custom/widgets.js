    ...
    return {
        init: function () {
            ...
            (t = document.querySelector("#kt_user_menu_dark_mode_toggle")) &&
                ...
                (a = document.getElementById("kt_charts_widget_2_chart")),
                (s = parseInt(KTUtil.css(a, "height"))),
                ...
                new ApexCharts(a, {
                    series: [
                        { name: "Net Profit", data: [30, 60, 80, 60, 30, 60, 80, 100, 80, 60, 60], margin: { left: 5, right: 5 } },
                        { name: "Revenue", data: [30, 60, 80, 60, 30, 60, 80, 100, 80, 60, 60] },
                    ],
                    chart: { fontFamily: "inherit", type: "bar", height: s, toolbar: { show: !1 } },
                    plotOptions: { bar: { horizontal: !1, columnWidth: ["50%"], borderRadius: 4 } },
                    legend: { show: !1 },
                    dataLabels: { enabled: !1 },
                    stroke: { show: !0, width: 2, colors: ["transparent"] },
                    xaxis: { axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !1, style: { colors: r, fontSize: "12px" } } },
                    ...
                    colors: [o, l],
                    grid: { borderColor: i, strokeDashArray: 4, yaxis: { lines: { show: !0 } }, padding: { left: -10, right: 5 } },
                }).render(),
                ...
                (d = document.querySelector("#kt_user_follow_button")) &&
                        ...
                        d.classList.contains("btn-success")
                            ? setTimeout(function () {
                                d.removeAttribute("data-kt-indicator"),
                                    ...
                                    d.querySelector(".svg-icon").classList.add("d-none"),
                                    (d.querySelector(".indicator-label").innerHTML = "Follow"),
                                    (d.disabled = !1);
                            }, 1500)
                            : setTimeout(function () {
                                d.removeAttribute("data-kt-indicator"),
                                    d.classList.add("btn-success"),
                                    d.classList.remove("btn-light"),
                                    d.querySelector(".svg-icon").classList.remove("d-none"),
                                    (d.querySelector(".indicator-label").innerHTML = "Following"),
                                    (d.disabled = !1);
                            }, 1e3);
                });
        },
