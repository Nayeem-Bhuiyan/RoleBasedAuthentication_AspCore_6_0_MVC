...
namespace NayeemApplication.Repository.CrudRepository.Interface
{
    public interface IRepositoryService<T> where T : Base
    {
        ...
        string Update(T updated, string key);
        Task<string> UpdateAsync(T updated, string key);
